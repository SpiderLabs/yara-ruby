...
== Versioning
The current version is 1.4.0. The major and minor version numbers are intended
to indicate the version of the yara library the bindings are written for. 

We may use the patch version to maintain our own patches or new features, 
however.
